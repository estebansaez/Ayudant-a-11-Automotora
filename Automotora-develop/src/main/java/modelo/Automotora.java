...
public class Automotora {
    ...
    public void añadirVehiculosPorVender(){
        this.vehiculosAVenta.add(new Vehiculo("Celerio", ColorVehiculo.BLANCO.getColorVehiculo(), MarcaVehiculo.SUZUKI.getMarcaVehiculo(),
        ...
        this.vehiculosAVenta.add(new Vehiculo("Cruze",ColorVehiculo.PLATEADO.getColorVehiculo(),MarcaVehiculo.CHEVROLET.getMarcaVehiculo(),
                2010,4500000,105000.144));
        this.vehiculosAVenta.add(new Vehiculo("Elantra",ColorVehiculo.AZUL.getColorVehiculo(),MarcaVehiculo.HYUNDAI.getMarcaVehiculo(),
                2020,6000000,70000));
        this.vehiculosAVenta.add(new Vehiculo("206",ColorVehiculo.VERDE.getColorVehiculo(),MarcaVehiculo.PEUGEOT.getMarcaVehiculo(),
                2019,15000000,130000));
        this.vehiculosAVenta.add(new Vehiculo("Ranger",ColorVehiculo.ROJO.getColorVehiculo(),MarcaVehiculo.FORD.getMarcaVehiculo(),
    ...
    public Venta generarVenta(String rutVendedor, String rutCliente, Vehiculo vehiculo) throws IOException{
        ...
        Venta venta = new Venta(vendedor, comprador, vehiculo);
    ...
    public Vendedor buscarCliente(String rut){
        ...
        if(cliente==null){
            for(Vendedor vendedorAux : this.vendedores){
                if(Objects.equals(vendedorAux.getRut(), rut)){
                    cliente = vendedorAux;
                    break;
                }
            }

...
//Lee cada linea del archivo hasta que la linea sea nula
            while ((textoArchivo = br.readLine()) != null) {
                ...
                String[] data = textoArchivo.split(",");
               /*automotora.getVehiculosAVenta().add(new Vehiculo(data[0], ColorVehiculo.valueOf(data[1].toUpperCase()),
                        MarcaVehiculo.valueOf(data[2].toUpperCase()), Integer.parseInt(data[3]), Integer.parseInt(data[4]),
